...
public class RoutesBase {
    ...
    public Response addRoutes(InputStream routeXML) throws IOException {
        ...
        Location to = Location.builder().x(routeDAO.getLocations().get(0).getX())
                .y(routeDAO.getLocations().get(0).getY())
                .z(routeDAO.getLocations().get(0).getZ())
                .name(routeDAO.getLocations().get(0).getName()).build();
        Location from = Location.builder().x(routeDAO.getLocations().get(1).getX())
                .y(routeDAO.getLocations().get(1).getY())
                .z(routeDAO.getLocations().get(1).getZ())
                .name(routeDAO.getLocations().get(1).getName()).build();
